...
namespace Txt
{
	...
	public:
		...
		void gotoStart();
		void gotoEnd();
        bool isAtEnd() const { return d_cur.atEnd(); }
        ...
        bool isLink() const;
        QByteArray getLink() const;
		void insertLink( const QByteArray&, QString text, const QString& icon = QString(),
						 const QString& id = QString() );
        bool isAnchor() const { return d_cur.charFormat().isAnchor(); }
		...
		const QTextCursor& qt() const { return d_cur; }
